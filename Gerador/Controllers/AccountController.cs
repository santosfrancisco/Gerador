    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "E-mail e/ou senha inválido.");
                    return View(model);
            }
        }
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl)
        {
            ...
            if (user != null)
            {
                ViewBag.Status = "Para fins de demonstração, o código enviado por " + provider + " é: " + await UserManager.GenerateTwoFactorTokenAsync(user.Id, provider);
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirme seu cadastro", "Por favor confirme seu cadastro clicando neste link: <a href=\"" + callbackUrl + "\">Confirmar</a>");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Alteração de senha", "Para criar uma nova senha <a href=\"" + callbackUrl + "\">clique aqui</a>");
                ViewBag.Link = callbackUrl;
                return View("ForgotPasswordConfirmation");
            }
